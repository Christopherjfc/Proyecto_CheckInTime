...
public class Profesor_lista extends AppCompatActivity {

    private Button guardar;
    private Spinner aula, curso, ciclo, grupo, fechaYhora;
    private ImageView btnMenu, imgFoto;
    private TextView perf, list, conf, modifAsis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profesor_lista);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Profesor_lista.this, "Lista guardada", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        modifAsis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Profesor_lista.this, Profesor_modificaAsistencia.class);
        ...
        imgFoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Profesor_lista.this, Profesor_perfil.class);
                startActivity(intent);
            }
        });
        ...
        list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Profesor_lista.this, Profesor_lista.class);
                startActivity(intent);
            }
        });
        ...
        conf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Profesor_lista.this, Profesor_configuraciones.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void mostrarSelectorFechaYHora() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(android.widget.DatePicker view, int year, int month, int dayOfMonth) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(Profesor_lista.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
