...
public class Admin_Prof_configuraciones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_prof_configuraciones);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Admin_Prof_configuraciones.this, "Preferencias guardadas", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Prof_configuraciones.this, Admin_main.class);
        ...
        imgFoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Prof_configuraciones.this, Admin_Prof_perfil.class);
                startActivity(intent);
            }
        });
        ...
        list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Prof_configuraciones.this, Admin_Prof_lista.class);
                startActivity(intent);
            }
        });
        ...
        conf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Prof_configuraciones.this, Admin_Prof_configuraciones.class);
                startActivity(intent);
            }
        });
    }
