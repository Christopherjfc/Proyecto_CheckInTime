...
public class Profesor_horario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgFoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Profesor_horario.this, Profesor_perfil.class);
        ...
        list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Profesor_horario.this, Profesor_lista.class);
                startActivity(intent);
            }
        });
        ...
        conf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Profesor_horario.this, Profesor_configuraciones.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void mostrarTimePicker() {
        ...
        TimePickerDialog timePicker = new TimePickerDialog(
                ...
                (view, hourOfDay, minute) -> {
                    ...
                    Toast.makeText(Profesor_horario.this, horaSeleccionada, Toast.LENGTH_LONG).show();
                },
                horaActual,
                minutoActual,
