...
public class Admin_Prof_modificaAsistencia extends AppCompatActivity {

    private Button guardar;
    private Spinner aula, curso, ciclo, grupo, fechaYhora;
    private ImageView btnMenu, imgFoto;
    private TextView perf, list, conf,main, mostra;
    private LinearLayout fondoMenu, linAsis;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_prof_modifica_asistencia);
        ...
        linAsis = findViewById(R.id.linearAsist);
        mostra = findViewById(R.id.mostrarAsistencia);
        ...
        mostra.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (linAsis.getVisibility() == View.GONE) {
                    linAsis.setVisibility(View.VISIBLE);
                } else {
                    linAsis.setVisibility(View.GONE);
                }
            }
        });
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Admin_Prof_modificaAsistencia.this, "Modificación realizada", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        imgFoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Prof_modificaAsistencia.this, Admin_Prof_perfil.class);
        ...
        main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Prof_modificaAsistencia.this, Admin_main.class);
                startActivity(intent);
            }
        });
        ...
        list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Prof_modificaAsistencia.this, Admin_Prof_lista.class);
                startActivity(intent);
            }
        });
        ...
        conf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Prof_modificaAsistencia.this, Admin_Prof_configuraciones.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void mostrarSelectorFechaYHora() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(android.widget.DatePicker view, int year, int month, int dayOfMonth) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(Admin_Prof_modificaAsistencia.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
