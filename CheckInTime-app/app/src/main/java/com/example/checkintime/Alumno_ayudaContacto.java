...
public class Alumno_ayudaContacto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alumno_ayuda_contacto);
        ...
        imgFoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Alumno_ayudaContacto.this, Alumno_perfil.class);
        ...
        asist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Alumno_ayudaContacto.this, Alumno_asistencia.class);
                startActivity(intent);
            }
        });
        ...
        conf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Alumno_ayudaContacto.this, Alumno_configuraciones.class);
                startActivity(intent);
            }
        });
    }
