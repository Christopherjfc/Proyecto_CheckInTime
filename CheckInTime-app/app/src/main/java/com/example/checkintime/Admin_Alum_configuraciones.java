...
public class Admin_Alum_configuraciones extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_alum_configuraciones);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Admin_Alum_configuraciones.this, "Preferencias guardadas", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Admin_Alum_configuraciones.this, Admin_main.class);
        ...
        imgFoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Alum_configuraciones.this, Admin_Alum_perfil.class);
                startActivity(intent);
            }
        });
        ...
        asist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Alum_configuraciones.this, Admin_Alum_asistencia.class);
                startActivity(intent);
            }
        });
        ...
        conf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Alum_configuraciones.this, Admin_Alum_configuraciones.class);
                startActivity(intent);
            }
        });
    }
