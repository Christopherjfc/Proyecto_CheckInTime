...
public class Profesor_modificaAsistencia extends AppCompatActivity {

    private Button guardar;
    private Spinner aula, curso, ciclo, grupo, fechaYhora;
    private ImageView btnMenu, imgFoto;
    private TextView perf, list, conf, mostra;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profesor_modifica_asistencia);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Profesor_modificaAsistencia.this, "Modificación realizada", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        imgFoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Profesor_modificaAsistencia.this, Profesor_perfil.class);
        ...
        list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Profesor_modificaAsistencia.this, Profesor_lista.class);
                startActivity(intent);
            }
        });
        ...
        conf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Profesor_modificaAsistencia.this, Profesor_configuraciones.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void mostrarSelectorFechaYHora() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(android.widget.DatePicker view, int year, int month, int dayOfMonth) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(Profesor_modificaAsistencia.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
